...
$scope.deleteFlashMessage = function(index){
  $scope.alerts.splice(index, 1);
};

$scope.addFlashMessage = function(){
  $scope.alerts.push({type: 'danger', msg: 'This is custom flash/alert message'});
};
/*--------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------*/
...
snmmaurya.controller('PopoverDemoCtrl', function ($scope) {
