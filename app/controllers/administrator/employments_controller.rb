class Administrator::EmploymentsController < ApplicationController
  ...
  def create
    ...
    if @employment.save
      ...
      redirect_to administrator_employments_path
    else
      render :new
    end
  end
  ...
  protected
    def   employment_params
      params.require(:employment).permit(:role, :company, :status, :joined_at, :leaved_at, :description)
    end
end